...
class MetricSettingsTest {
    ...
    void setQfMetricsSettingsTest() {
        ...
        metricSettings.setAmcConfig(new MetricConfig(new MetricThreshold(Metric.AMC, Double.parseDouble(qfMetricsSettings.getAmcMin()), Double.parseDouble(qfMetricsSettings.getAmcMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setCaConfig(new MetricConfig(new MetricThreshold(Metric.CA, Double.parseDouble(qfMetricsSettings.getCaMin()), Double.parseDouble(qfMetricsSettings.getCaMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setCamConfig(new MetricConfig(new MetricThreshold(Metric.CAM, Double.parseDouble(qfMetricsSettings.getCaMin()), Double.parseDouble(qfMetricsSettings.getCaMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setCbmConfig(new MetricConfig(new MetricThreshold(Metric.CBM, Double.parseDouble(qfMetricsSettings.getCbmMin()), Double.parseDouble(qfMetricsSettings.getCbmMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setCboConfig(new MetricConfig(new MetricThreshold(Metric.CBO, Double.parseDouble(qfMetricsSettings.getCboMin()), Double.parseDouble(qfMetricsSettings.getCboMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setCcConfig(new MetricConfig(new MetricThreshold(Metric.CC, Double.parseDouble(qfMetricsSettings.getCcMin()), Double.parseDouble(qfMetricsSettings.getCcMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setCeConfig(new MetricConfig(new MetricThreshold(Metric.CE, Double.parseDouble(qfMetricsSettings.getCeMin()), Double.parseDouble(qfMetricsSettings.getCeMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setDamConfig(new MetricConfig(new MetricThreshold(Metric.DAM, Double.parseDouble(qfMetricsSettings.getDamMin()), Double.parseDouble(qfMetricsSettings.getDamMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setDitConfig(new MetricConfig(new MetricThreshold(Metric.DIT, Double.parseDouble(qfMetricsSettings.getDitMin()), Double.parseDouble(qfMetricsSettings.getDitMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setIcConfig(new MetricConfig(new MetricThreshold(Metric.IC, Double.parseDouble(qfMetricsSettings.getIcMin()), Double.parseDouble(qfMetricsSettings.getIcMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setLcomConfig(new MetricConfig(new MetricThreshold(Metric.LCOM, Double.parseDouble(qfMetricsSettings.getLcomMin()), Double.parseDouble(qfMetricsSettings.getLcomMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setLcom3Config(new MetricConfig(new MetricThreshold(Metric.LCOM3, Double.parseDouble(qfMetricsSettings.getLcom3Min()), Double.parseDouble(qfMetricsSettings.getLcom3Max())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setLocConfig(new MetricConfig(new MetricThreshold(Metric.LOC, Double.parseDouble(qfMetricsSettings.getLocMin()), Double.parseDouble(qfMetricsSettings.getLocMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setMfaConfig(new MetricConfig(new MetricThreshold(Metric.MFA, Double.parseDouble(qfMetricsSettings.getMfaMin()), Double.parseDouble(qfMetricsSettings.getMfaMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setMoaConfig(new MetricConfig(new MetricThreshold(Metric.MOA, Double.parseDouble(qfMetricsSettings.getMoaMin()), Double.parseDouble(qfMetricsSettings.getMoaMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setNocConfig(new MetricConfig(new MetricThreshold(Metric.NOC, Double.parseDouble(qfMetricsSettings.getNocMin()), Double.parseDouble(qfMetricsSettings.getNocMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setNpmConfig(new MetricConfig(new MetricThreshold(Metric.NPM, Double.parseDouble(qfMetricsSettings.getNpmMin()), Double.parseDouble(qfMetricsSettings.getNpmMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setRfcConfig(new MetricConfig(new MetricThreshold(Metric.RFC, Double.parseDouble(qfMetricsSettings.getRfcMin()), Double.parseDouble(qfMetricsSettings.getRfcMax())), new MetricsFeedbackSuggestion("lower", "upper")));
        ...
        metricSettings.setWmcConfig(new MetricConfig(new MetricThreshold(Metric.WMC, Double.parseDouble(qfMetricsSettings.getWmcMin()), Double.parseDouble(qfMetricsSettings.getWmcMax())), new MetricsFeedbackSuggestion("lower", "upper")));

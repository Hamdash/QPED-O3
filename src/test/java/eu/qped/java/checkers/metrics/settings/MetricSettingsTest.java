...
class MetricSettingsTest {
    ...
    void setQfMetricsSettingsTest() {
        ...
        assertThat(metricSettings.getAmcConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getAmcConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getCaConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getCaConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getCamConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getCamConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getCbmConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getCbmConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getCboConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getCboConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getCcConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getCcConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getCeConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getCeConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getDamConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getDamConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getDitConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getDitConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getIcConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getIcConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getLcomConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getLcomConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getLcom3Config().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getLcom3Config().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getLocConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getLocConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getMfaConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getMfaConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getMoaConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getMoaConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getNocConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getNocConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getNpmConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getNpmConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getRfcConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getRfcConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
        ...
        assertThat(metricSettings.getWmcConfig().getMetricThreshold().getMin(), allOf(greaterThan(0.), lessThan(0.5)));
        assertThat(metricSettings.getWmcConfig().getMetricThreshold().getMax(), allOf(greaterThan(0.5), lessThan(1.)));
